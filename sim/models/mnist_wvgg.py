'''Wide (or scaling) VGG for MNIST/Fashion-MNIST
...
def make_layers(cfg, k, batch_norm = False) -> nn.Sequential:
    ...
    in_channels = 1 # Modified for MNIST (liyipeng, 2024-03-26)
    for v in cfg:
        if v == "M":
...
def wvgg5k1(**kwargs: Any) -> VGG:
    return _vgg("WA", 1, False, **kwargs)

def wvgg5k2(**kwargs: Any) -> VGG:
    return _vgg("WA", 2, False, **kwargs)

def wvgg5k4(**kwargs: Any) -> VGG:
    return _vgg("WA", 4, False, **kwargs)

def wvgg5k8(**kwargs: Any) -> VGG:
    return _vgg("WA", 8, False, **kwargs)

def wvgg5k10(**kwargs: Any) -> VGG:
    return _vgg("WA", 10, False, **kwargs)

def wvgg7k1(**kwargs: Any) -> VGG:
    return _vgg("WA2", 1, False, **kwargs)

def wvgg7k2(**kwargs: Any) -> VGG:
    return _vgg("WA2", 2, False, **kwargs)

def wvgg7k4(**kwargs: Any) -> VGG:
    return _vgg("WA2", 4, False, **kwargs)

def wvgg7k8(**kwargs: Any) -> VGG:
    return _vgg("WA2", 8, False, **kwargs)

if __name__ == '__main__':
    from pytorch_model_summary import summary
    from model_utils import count_parameters
    model = wvgg7k8(num_classes=10)
