...
def build_partition(dataset_name='mnist', num_clients=10, num_groups=10, partition='iid', alpha=[]):
...
class GroupIIDClientNonIIDPartitioner(Partitioner):
    ...
    """
    def __init__(self, dataset_name='mnist', num_groups=10, alpha=1.0):
...
def main():
    ...
    labels = list(
        train_dataset.targets)  # Note: `train_dataset.targets` is a list in cifar10/100 , but a tensor in mnist (yipeng, 2023-04-26)
