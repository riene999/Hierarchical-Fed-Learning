...
# python sim/data/partition_LR.py -d mnist -n 10 --partition exdir -C 1 --alpha 1.0 
def main():
    import argparse
    ...
    num_class_dict = { 'mushrooms': 2, 'w8a': 2, 'a9a': 2, 'a5a': 2, 'a1a': 2}
    A, b = get_dataset(dataset_name, data_path=dataset_dir)
    labels = b
    ...
    if dataset_name in num_class_dict.keys():
...
if __name__ == '__main__':
    from datasets_LR import get_dataset
    main()